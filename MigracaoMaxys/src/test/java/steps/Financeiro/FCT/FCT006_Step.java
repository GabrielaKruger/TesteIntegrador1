...
public class FCT006_Step {
    ...
    public void recarregarOProgramaFeatureFCT006() {
    ...
    @E("apresentar a mensagem parcial {string} feature FCT006")
    public void apresentarAMensagemParcialFeatureFCT006(String mensagem) {
    ...
    public void realizarAConsultaFeatureFCT006() {
        ...
        basePage.esperarMilissegundos(30000); //espera necessária - Tempo para carregar massa no Grid
    }
