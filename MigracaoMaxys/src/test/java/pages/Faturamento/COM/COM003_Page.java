...
public class COM003_Page extends BasePage {
    WebDriver driver;

    public COM003_Page(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
    ...
    public void preencherCliforFeatureCOM003(String clifor) {
    ...
    public void preencherCondiçãoPagtoFeatureCOM003(String condicaoPagamento) {
    ...
    public void preencherMoedaFeatureCOM003(String moeda) {
    ...
    public void preencherFormaPagamentoFeatureCOM003(String formaPagamento) {
    ...
    public void preencherTaxaFeatureCOM003(String valorTaxa) {
